...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CSE","IT","ECE","MAE","BBA/MBA")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BBA","MBA","Mtech","BE","BTech")
        cou_combo.current(0)
        ...
        #Roll No
        student_roll_label = Label(class_Student_frame,text="Roll:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Phone Number
        student_phone_label = Label(class_Student_frame,text="Phone-No:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        student_phone_label.grid(row=3,column=2,padx=5,pady=5,sticky=W)

        student_phone_entry = ttk.Entry(class_Student_frame,textvariable=self.var_phone,width=15,font=("verdana",12,"bold"))
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("ID","Name","Dep","Course","Year","Sem","Div","Gender","DOB","Phone-No","Address","Roll","Email","Teacher","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(username='root', password='root',host='localhost',database='face_recognizer',port=3306)
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,DOB=%s,Phone_No=%s,Address=%s,Roll=%s,Email=%s,Teacher=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Course,Year,Semester,Division,Gender,DOB,Phone_No,Address,Roll,Email,Teacher,PhotoSample FROM student where Roll_No='" +str(self.var_search.get()) + "'" 
